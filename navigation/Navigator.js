...
const DrawerNavigator=createDrawerNavigator({
    ...
    paymentScreen:{
      ...
      navigationOptions:{
        title:"Pricing",
        drawerIcon:({tintColor})=><MaterialIcons name="payments" color={tintColor} size={20} />
      }
    },
    favoriteScreen:{
      ...
      navigationOptions:{
        title:"Favorites",
        drawerIcon:({tintColor})=><Feather name="heart" color={tintColor} size={20} />
      }
    }
  },{
    ...
    contentOptions:{
      activeBackgroundColor:"rgba(242,145,152,0.4)",
