...
/>
        ...
        <View  style={styles.container} >
            ...
            <Image style={{height:"72%",width:"100%",borderRadius:150}} source={foodImage} />
            </View>
        </View>
        ...
        <View style={styles.buttonContainer}>
           ...
           <TouchableOpacity style={styles.button2} onPress={()=>{props.navigation.navigate("signInScreen")}}>
                <Text style={{textAlign:"center",fontWeight:"bold",color:"#000"}}>Sign In</Text>
           </TouchableOpacity>
        </View>
    </View>
    </ImageBackground>
